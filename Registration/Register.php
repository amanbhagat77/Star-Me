...
<head>
    ...
    <style>
        body{
            background: url(../images/login-page-background-images-9.jpg);
        }
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <a class="navbar-brand" id="head" href="#section1">StarMeUp.com</a>
      <form class="form-inline my-2 my-md-0">
          <input class="form-control" type="text" placeholder="Search" aria-label="Search">
      </form>
    <ul class="nav nav-pills nav-masthead mr-auto">
        <li class="nav-item">   
            <a class="nav-link active"  href="#C:\Users\Aman\Desktop\New Project\mianpage.html">Home</a>
        </li>
...
<div class="container" >
     <header>
            <div id="new"> <centre><h1>Register</h1></centre></div>
            </header>
    <div class="row user-menu-container square">
        ...
        <div class="col-md-6 user-details register_box bg-light">
            <img src="../images/starmeh.PNG" class="logo">
